    ...
    >
      ...
      <Section title="六、投票与契约币">
        <List items={[
          ...
          '黑榜不开放付费负面打榜；负面经历请发布黑榜主帖、补充评论、提交举报或申请相关方回应。',
          '赞扬人和欢乐记录可作为公开口碑的一部分展示。',
    ...
    >
      ...
      <Section title="三、公开展示的信息">
        <List items={[
          ...
          '红黑白榜、评论、欢乐、赞扬、委托需求和接单状态可能按产品规则公开展示。',
  ...
  return (
    ...
    >
      ...
      <Section title="六、契约币与费用">
        <List items={[
          '契约币是灵契站内余额名称，用于红榜发布、评论、赞扬等站内操作。',
