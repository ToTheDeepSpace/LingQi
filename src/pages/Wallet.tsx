        ...
        <div style={{
          ...
          {done ? (
            <div style={{ textAlign: 'center', padding: '20px 0' }}>
              ...
              <p style={{ color: MUTED, marginBottom: 16 }}>充值申请已提交，等待管理员审核</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div>
                ...
                <textarea value={paymentProof} onChange={e => setPaymentProof(e.target.value)}
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(201,146,46,0.28)', background: '#fff',
              ...
              <button onClick={submitRecharge} disabled={submitting}
                style={{
                  ...
                  color: submitting ? 'rgba(201,146,46,0.4)' : INK, border: 'none',
                }}>
