...
export function UserAgreement() {
  return (
    <LegalLayout
      title="灵契用户协议"
      intro="欢迎使用灵契。本协议用于说明你在使用灵契账号、灵契大厅、委托需求墙、红黑白榜、契约币、评论和相关方回应等功能时需要遵守的基本规则。继续使用灵契，即视为你理解并同意本协议。"
    >
      <Section title="一、服务说明">
        <List items={[
          '灵契是连接委托人、灵契师及配套服务人员的原型期平台，当前功能包括主页展示、委托需求、红黑白榜、评论、相关方回应、契约币余额和人工审核。',
      ...
      <Section title="四、红黑白榜与评论">
        <List items={[
          ...
          '黑榜公开展示默认 30 天后过期隐藏，严重违法、长期风险或公共利益相关内容可由管理员特殊处理。',
