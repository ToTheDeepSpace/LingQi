...
export const demoEvents: DemoEvent[] = [
  { id: 'red', kind: '红榜', title: '散场后，那段没说完的故事', subject: '林川 · 西安', tags: ['用户自述', '相关方已回应'], summary: '【虚构事件】玩家记录：演绎中遇到不适时，DM 先暂停确认边界，散场后也认真完成了复盘。这条记录关注具体服务体验，不替任何人做永久背书。', response: '【虚构回应】谢谢记录。每个人的边界不同，开场前的沟通和过程中的确认都很重要。', dossier: 'lin' },
