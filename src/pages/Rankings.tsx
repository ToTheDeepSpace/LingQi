...
function RoadmapPreview() {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ maxWidth: 720 }}>
          ...
          <p style={{ margin: '10px 0 0', color: '#4b5563', lineHeight: 1.7, fontSize: 15 }}>
            当前优先验证真实发布、人工审核、相关方回应和带成本投票。AI、信息聚合和阶段投票会在商业模式与数据规模验证后逐步开放，模型优先选择大陆可采购、低成本、中文语境更稳定的方案。
          </p>
        </div>
        <Link
          to="/contact"
      ...
      >
        黑榜 30 天公开期不是删除记录，而是把“持续公开挂人”和“长期行业学习”分开：公开期结束后，必要记录仍可用于争议处理和安全审计，后续也会优先做去标识化的共性问题总结。欢迎投资机构、沉浸式娱乐从业者、店家、DM、委托师和技术合作者提供样本、规则建议与共建资源。
      </div>
    </section>
  );
}
