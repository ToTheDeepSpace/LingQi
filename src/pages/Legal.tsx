  ...
  return (
    ...
    >
      ...
      <Section title="六、投票与契约币">
        <List items={[
	          '红榜和白榜的打榜、反对、欢乐遵循一人一票，不可重复投票。',
	          '打榜消耗契约币；反对和欢乐免费，但同样占用一人一票名额。',
	          '黑榜只开放免费同意和反对，表达对事件记录的判断，不开放付费负面打榜。',
	          '投票时可以顺带发表一条免费评论；普通评论本身也免费，但需要遵守审核规则。',
	          '打榜、欢乐、同意、反对记录可作为公开口碑的一部分展示。',
      ...
      <Section title="二、我们如何使用信息">
        <List items={[
          ...
          '用于人工审核帖子、评论、相关方回应、认证材料和充值申请。',
	          '用于计算契约币余额、处理发布、打榜、欢乐、同意、反对等站内操作。',
      ...
      <Section title="三、公开展示的信息">
        <List items={[
          ...
          '实名或认证用户可能展示星标、蓝 V、DM 认证等标识，但不公开证件信息。',
	          '红黑白榜、评论、欢乐、打榜、同意、反对、委托需求和接单状态可能按产品规则公开展示。',
    ...
    >
      ...
      <Section title="四、红黑白榜与评论">
        <List items={[
          ...
          '黑榜公开展示默认 30 天后进入已过期记录，严重违法、长期风险或公共利益相关内容可由管理员特殊处理；进入已过期记录不等于删除全部记录，平台可在必要范围内保留争议处理记录，并在去标识化后总结共性问题。',
      ...
      <Section title="六、契约币与费用">
        <List items={[
	          '契约币是灵契站内余额名称，用于红榜发布、打榜、拼车加权展示等站内操作；普通评论免费。',
	          '原型期可能存在新户赠送、邀请奖励、人工充值、支付宝充值、微信支付充值等方式；其中充值所得为充值币，赠送和奖励所得为赠币，消费默认先扣赠币再扣充值币。',
	          '黑榜同意和反对免费，不开放付费负面打榜。',
