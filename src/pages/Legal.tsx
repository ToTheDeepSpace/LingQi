    ...
    >
      ...
      <Section title="六、投票与契约币">
        <List items={[
		          ...
		          '同意、反对和离谱属于免费态度，同一账号对同一帖子只保留一个免费态度。',
		          '黑榜同样可以表达免费态度；涉及事实补充或不同意见时，也可以顺带发表免费评论。',
    ...
    >
      ...
      <Section title="四、红黑白榜、评论与相关方回应">
        <List items={[
          ...
          '同意、反对、欢乐等免费态度通常按一人一票处理；打榜、踩榜等付费加权只表达站内展示权重和用户态度，不代表平台认可或否定事实。',
      ...
      <Section title="七、契约币、充值、赠币与发票">
        <List items={[
          ...
          '同意、反对和欢乐等免费态度通常不消耗契约币；打榜和踩榜按实际契约币金额累计。',
