  ...
  return (
    ...
    >
      ...
      <Section title="六、投票与契约币">
        <List items={[
	          '红榜和白榜的赞扬、欢乐遵循一人一票，不可重复投票。',
	          '赞扬消耗契约币；欢乐免费，但同样占用一人一票名额。',
	          '黑榜只开放免费赞同和反对，表达对事件记录的判断，不开放付费负面打榜。',
	          '赞同或反对黑榜时，可以顺带发表一条免费评论；普通评论本身也免费，但需要遵守审核规则。',
	          '赞扬、欢乐、赞同、反对记录可作为公开口碑的一部分展示。',
      ...
      <Section title="二、我们如何使用信息">
        <List items={[
          ...
          '用于人工审核帖子、评论、相关方回应、认证材料和充值申请。',
	          '用于计算契约币余额、处理发布、赞扬、欢乐、赞同、反对等站内操作。',
      ...
      <Section title="三、公开展示的信息">
        <List items={[
          ...
          '实名或认证用户可能展示星标、蓝 V、DM 认证等标识，但不公开证件信息。',
	          '红黑白榜、评论、欢乐、赞扬、赞同、反对、委托需求和接单状态可能按产品规则公开展示。',
  ...
  return (
    ...
    >
      ...
      <Section title="六、契约币与费用">
        <List items={[
	          '契约币是灵契站内余额名称，用于红榜发布、赞扬、拼车加权展示等站内操作；普通评论免费。',
